...
- [x] **Phase 24: VPS Infrastructure** - systemd, Nginx reverse proxy, TLS, SQLite WAL mode, and production env file (completed 2026-03-12)
...
| 25. Core Visual Assets | v2.0 | 1/2 | In Progress | - |
